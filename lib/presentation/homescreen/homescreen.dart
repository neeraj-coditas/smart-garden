...
import 'package:smart_garden/presentation/shop_screen/shop_screen.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  int _selectedBottomNavigationTab = 0;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: _selectedBottomNavigationTab == 0
          ? Container(
              decoration: const BoxDecoration(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                                ...
                                image: const DecorationImage(
                                    image:
                                        AssetImage('assets/settings_bg.png'))),
                            child: const Image(
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: GestureDetector(
                              onTap: () {
                                setState(() {
                                  _selectedBottomNavigationTab = 2;
                                });
                              },
                              child: const Image(
                                  image: AssetImage('assets/profile_grey.png')),
                            ),
                          ),
                        ],
                      ),
          ...
          : _selectedBottomNavigationTab == 1
              ? Container()
              : _selectedBottomNavigationTab == 2
                  ? Container(
                      decoration: const BoxDecoration(
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: GestureDetector(
                                      onTap: () {
                                        setState(() {
                                          _selectedBottomNavigationTab = 0;
                                        });
                                      },
                                      child: const Image(
                                          image: AssetImage(
                                              'assets/logo_disabled.png')),
                                    ),
                                  ),
                                  const Padding(
                                    padding: EdgeInsets.symmetric(vertical: 12),
